...
const TypingIndicator = React.memo(function TypingIndicator() {
  return (
    <div className="flex items-center gap-2.5 text-sm justify-start pb-6">
...
function HistoryBeginningMarker() {
  return (
    <div className="flex items-center justify-center gap-2 py-4 mb-2 text-xs text-zinc-400 dark:text-zinc-500 select-none">
...
export function MessageList({
    ...
    if (wasPrepended) {
      ...
      requestAnimationFrame(() => {
        ...
        if (currentList) {
          ...
          if (updatedDelta > 0 && Math.abs(currentList.scrollOffset - (prevScrollOffsetRef.current + updatedDelta)) > 2) {
  ...
  return (
    <div className="relative flex flex-1 flex-col overflow-hidden">
      ...
      <VList ref={listRef} className="flex-1 overflow-y-auto p-4 sm:p-6" shift={false} onScroll={handleScroll}>
