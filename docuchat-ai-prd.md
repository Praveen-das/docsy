# DocuChat AI — Project Requirements Document
...
DocuChat AI is a web application that allows authenticated users to upload PDF documents and have grounded, citation-aware conversations with them using Retrieval-Augmented Generation (RAG).
...
**DocuChat AI — RAG-Powered Document Assistant**
